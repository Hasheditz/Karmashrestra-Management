  ...
  return (
    <div className="small-container">
      <form onSubmit={handleUpdate}>
        <h1>Edit Student</h1>
        <label htmlFor="title">Name of Student</label>
        <input
          id="title"
          type="text"
          name="title"
        ...
        />
        <label htmlFor="image">Image of Studemnt</label>
        <input
          id="image"
          type="url"
          name="image"
        ...
        />
        <label htmlFor="price">Age of Student</label>
        <input
          id="price"
          type="number"
          name="price"
        ...
        />
        <label htmlFor="createdAt">Enrolled on</label>
        <input
          id="createdAt"
          type="date"
          name="createdAt"
